...
% figure(11)
% 
% semilogx(step(1:end-1), sol(1:end-1), '--mo', 'LineWidth', 2)
% 
% %title('Convergence of the solution for a decreasing time step')
% ylabel('Displacement in the x-direction of the 6th node [m]') 
% xlabel('Time step taken [s]') 
% 
% figure(12)
% 
% plot(time, q(31, :), 'LineWidth', 2)
% 
% title('Convergence of the solution for a decreasing time step')
% xlabel('Displacement in the x-direction of the 6th node [m]') 
% ylabel('Time step taken [s]') 
% 
% %save('implicit_sol', 'q')
